...
def countdown(t):
    ...
    while True:
        if (until - datetime.datetime.now()).total_seconds() > 0:
            stdout.flush()
            stdout.write("\r " + Fore.MAGENTA + "[*]" + Fore.WHITE + " Trạng Thái Tấn Công => " + str(
                (until - datetime.datetime.now()).total_seconds()) + " Thời Gian Còn Lại ")
        else:
            stdout.flush()
            stdout.write(
                "\r " + Fore.MAGENTA + "[*]" + Fore.WHITE + " Tấn Công Thành Công !                                   \n")
            return
  ...
  printf(Center.XCenter(Colorate.Vertical(Colors.red_to_purple, f'''
    ...
    ╔═════════╩═════════════════════════════════╩═════════╗
      ...
      ➡ credits              |         information
                ...
                https://fb.com/nguyenducphu.developer
